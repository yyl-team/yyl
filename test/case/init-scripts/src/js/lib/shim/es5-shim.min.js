...
;(function (t, r) {
  ...
  var Dt = !{ toString: null }.propertyIsEnumerable('toString')
  var xt = function () {}.propertyIsEnumerable('prototype')
  var St = !G('x', '0')
  var Ot = function (t) {
    var r = t.constructor
  ...
  var Or = '\u200b'
  var Er = '[' + Sr + ']'
  var jr = new RegExp('^' + Er + Er + '*')
  var Ir = new RegExp(Er + Er + '*$')
  var Mr = f.trim && (Sr.trim() || !Or.trim())
  $(
    f,
    {
      trim: function trim() {
  ...
  if (parseInt(Sr + '08') !== 8 || parseInt(Sr + '0x16') !== 22) {
    parseInt = (function (t) {
      var r = /^[\-+]?0[xX]/

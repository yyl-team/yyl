...
setting.proxy.localRemote[`http://web.testhost.com/${PROJECT_NAME}`] = `http://127.0.0.1:5000/project/${PROJECT_NAME}/${PLATFORM}/html`
setting.proxy.localRemote[`http://webtest.testhost.com/${PROJECT_NAME}`] = `http://127.0.0.1:5000/project/${PROJECT_NAME}/${PLATFORM}/html`

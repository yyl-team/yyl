...
;(function (e, t) {
  ...
  var X =
    typeof W === 'function' && typeof W['for'] === 'function' && K.symbol(W())
  ...
  qe.prototype.next = function () {
    ...
    this._i = t + o
    return { value: e.substr(t, o), done: false }
  }
  me(qe.prototype)
  ...
  var $e = function (e, t) {
    g(this, { object: e, array: Be(e), kind: t })
  }
  g($e.prototype, {
    next: function next() {
      var e
  ...
  if (
    ...
    g(Array.prototype, { values: Array.prototype[Z] })
  ...
  if (Object.getOwnPropertyDescriptor) {
    ...
    if (!_t) {
      ...
      U(Object, 'getOwnPropertyDescriptor', function getOwnPropertyDescriptor(
        e,
        t
      ) {
  ...
  var vr = {
    ...
    clz32: function clz32(e) {
      ...
      return pr ? ee.Call(pr, r) : 31 - _(F(r + 0.5) * Math.LOG2E)
    },
  ...
  var wr = (function () {
    ...
    var i = ee.IsCallable(S.setImmediate)
      ? S.setImmediate
  ...
  if (s) {
    ...
    if (S.Map || S.Set) {
      ...
      if (
        ...
        u(S.Map) ||
        u(S.Set) ||
        typeof new S.Map().keys().next !== 'function' ||
        cn ||
        !tn
      ) {
        g(S, { Map: qr.Map, Set: qr.Set }, true)
      }

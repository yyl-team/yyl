      ...
      　5.2.5.[JS层](#525-JS层)    
            ...
            5.2.5.3[MVVM和类MVC框架](#5253-MVVM和类MVC框架)
                5.2.5.3.1[ReactJS](#52531-ReactJS)  
                    ...
                    5.2.5.3.1.2[ReactDOM.render()](#525312-ReactDOM.render())   
                    5.2.5.3.1.3[JSX 语法](#525313-JSX 语法)   
                    5.2.5.3.1.4[封装组件](#525314-封装组件)  
                    5.2.5.3.1.5[PropTypes 属性](#525315-PropTypes 属性)  
                    5.2.5.3.1.6[this.state](#525315-this.state)  
                5.2.5.3.2[ReactJS](#52532-VueJS)  
        ...
        5.2.6.[自动化构建工具](#526-自动化构建工具)   
            5.2.6.1[GULP](#5261-GULP)  
                ...
                5.2.6.1.2[GULP的插件使用](#52611-GULP的插件使用)
                    ...
                    5.2.6.1.2.7[生成雪碧图-- gulp.spritesmith](#526127-生成雪碧图-- gulp.spritesmith)  
